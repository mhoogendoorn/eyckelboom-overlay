...
RDEPEND="${COMMON_DEPEND}
	...
	dev-python/PyQt5[${PYTHON_USEDEP},declarative,gui,multimedia,network,opengl,printsupport,sql,webchannel,webkit?,webengine,widgets]
	dev-python/sip[${PYTHON_USEDEP}]
	dev-python/attrs[${PYTHON_USEDEP}]
	>=dev-python/pyyaml-3.12[${PYTHON_USEDEP}]
	webkit? ( dev-qt/qtwebkit:5[gstreamer?] )
"
...
python_install_all() {
	...
	dodoc doc/changelog.asciidoc
	dodoc doc/contributing.html
...
pkg_postinst() {
	...
	optfeature "Colored logging output" dev-python/colorlog
